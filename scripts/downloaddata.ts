...
export class DownloadExampleFiles {
    ...
    private data: { [key: string]: Object }[] = [
        {
            ...
            'Supervisor ID': '', 'Image URL': './assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg'
        },
        {
            ...
            'Supervisor ID': '1', 'Image URL': './assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg'
        },
        {
        ...
        },
        {
            ...
            'Supervisor ID': '3', 'Image URL': './assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg'
        },
        {
    ...
    public downloadXML(): void {
        let xmltext: string = '<?xml version="1.0" encoding="utf-8" ?><people>' +
            '<person Name="Maria Anders" Role="Managing Director" Location="US" Phone="(555) 111-1111" Email="mariaanders@fakecompany.com" ImageURL="./assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg">' +
            '<person Name="Carine Schmitt" Role="Project Manager" Department="Development" Location="US" Phone="(555) 222-2222" Email="carineschmitt@fakecompany.com" SupervisorName="Maria Anders" ImageURL="./assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg"></person>' +
            '<person Name="Daniel Tonini" Role="Project Manager" Department="Development" Location="US" Phone="(555) 333-3333" Email="danieltonini@fakecompany.com" SupervisorName="Maria Anders" ImageURL="./assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg">' +
            '<person Name="Alex Camino" Role="Project Manager" Department="Development" Location="US" Phone="(555) 444-4444" Email="alexcamino@fakecompany.com" SupervisorName="Daniel Tonini" ImageURL="./assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg"></person>' +
            '<person Name="Jones Bergson" Role="Project Lead" Department="Development" Location="US" Phone="(555) 555-5555" Email="jonesbergson@fakecompany.com" SupervisorName="Daniel Tonini" ImageURL="./assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg"></person>' +
            '<person Name="Rene Phillips" Role="Project Lead" Department="Development" Location="US" Phone="(555) 666-6666" Email="renephillips@fakecompany.com" SupervisorName="Daniel Tonini" ImageURL="./assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg"></person>' +
            '</person>' +
            '</person>' +
            '</people>';
